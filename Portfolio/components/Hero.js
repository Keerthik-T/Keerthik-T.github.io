        ...
        <section className="min-h-screen flex items-center justify-center pt-20 px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-lg md:text-xl max-w-2xl mx-auto mb-12 transition-colors">
                    I'm a Lead Web Developer specializing in building exceptional digital experiences. Currently, I'm focused on building scalable, human-centered products and obtaining industry-recognized certifications to expand my expertise.
                </p>
