    ...
    return (
        <section className="min-h-screen flex items-center justify-center pt-20 px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <h3 className="text-3xl md:text-5xl font-bold text-slate-600 dark:text-slate-400 mb-8 transition-colors">Bridging Digital Infrastructure and Behavioral Intelligence</h3>
                <p className="text-slate-600 dark:text-slate-400 text-lg md:text-xl max-w-3xl mx-auto mb-12 transition-colors">
                    With a core foundation in Linux environments and Computer Networking, I specialize in developing secure, scalable digital solutions. My methodology is rooted in Social Engineering and Analytical Psychology; I utilize cognitive modeling to understand how users interact with security protocols. This unique perspective allows me to engineer systems that prioritize robust defense without sacrificing intuitive human experience.
                </p>
